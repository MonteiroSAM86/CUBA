    ...
    <div class="main-navbar">
        ...
        <ul class="nav-menu custom-scrollbar">
            ...
            <ul class="nav-submenu menu-content">
                ...
                <li><a href="index.php">Light Layout</a></li>
            ...
            <li class="dropdown"><a class="nav-link menu-title link-nav" href="../starter-kit/index.php" target="_blank"><i data-feather="anchor"></i><span>Starter kit</span></a></li>
