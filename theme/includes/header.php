    ...
    <div class="main-header-right row m-0">
        ...
        <ul>
            ...
            <form class="form-inline search-form">
                ...
                <input class="form-control-plaintext" placeholder="Procurar...">
        ...
        <ul class="nav-menus">
            ...
            <ul class="notification-dropdown onhover-show-div">
                <li>
                <p class="f-w-600 font-roboto">Tem 3 notifications</p>
                </li>
                <li>
            ...
            <ul class="profile-dropdown onhover-show-div">
                ...
                <li><i data-feather="log-in"> </i><span><a href=../login/logout.php>Log out</a> </span></li>
            </ul>
            </li>
        </ul>
        </div>
